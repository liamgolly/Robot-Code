...
public class BrownoutProtectionCommand extends CommandBase {
    ...
    public BrownoutProtectionCommand(ClimbSubsystem climbSubsystem, ColorWheelSubsystem colorWheelSubsystem, CurrentLimiterSubsystem currentLimiterSubsystem, DrivetrainSubsystem drivetrainSubsystem, HopperSubsystem hopperSubsystem, IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem, TurretIntakeSubsystem turretIntakeSubsystem, TurretRotatorSubsystem turretRotatorSubsystem) {
        ...
        addRequirements(climbSubsystem, colorWheelSubsystem, currentLimiterSubsystem, drivetrainSubsystem, hopperSubsystem, intakeSubsystem, shooterSubsystem, turretIntakeSubsystem, turretRotatorSubsystem);
    }
    ...
    @Override
    public void execute() {
        int input = climbSubsystem.ClimbMotors()
