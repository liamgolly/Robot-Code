...
//                                xboxController));
        ...
        testButton.whileHeld(new AutoBeginMovement(m_driveTrainSubsystem, m_hopperSubsystem, m_intakeSubsystem, m_shooterSubsystem, m_turretIntakeSubsystem, m_turretRotatorSubsystem, NavX));
